...
------------
  ...
  -- Tier 10 Sets
	...
	--T2 Token Tables
	AtlasLoot_TableNames["T2Bracers"] = {"Teir 2 Bracers", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2Belts"] = {"Teir 2 Belts", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2Gloves"] = {"Teir 2 Gloves", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2Shoulders"] = {"Teir 2 Shoulders", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T2Boots"] = {"Teir 2 Boots", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["T3Gloves"] = {"Teir 3 Gloves", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3Shoulders"] = {"Teir 3 Shoulders", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3Boots"] = {"Teir 3 Boots", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3Legs"] = {"Teir 3 Legs", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3Helms"] = {"Teir 3 Helms", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3Chests"] = {"Teir 3 Chests", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T3Rings"] = {"Teir 3 Chests", "AtlasLootOriginalWoW" };
	--T4 Token Tables
	AtlasLoot_TableNames["T4Bracers"] = {"Teir 4 Bracers", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T4Belts"] = {"Teir 4 Belts", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T4Gloves"] = {"Teir 4 Gloves", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T4Shoulders"] = {"Teir 4 Shoulders", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T4Boots"] = {"Teir 4 Boots", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T4Legs"] = {"Teir 4 Legs", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T4Helms"] = {"Teir 4 Helms", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T4Chests"] = {"Teir 4 Chests", "AtlasLootOriginalWoW" };
	--T5 Token Tables
	AtlasLoot_TableNames["T5Bracers"] = {"Teir 5 Bracers", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T5Belts"] = {"Teir 5 Belts", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T5Gloves"] = {"Teir 5 Gloves", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T5Shoulders"] = {"Teir 5 Shoulders", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T5Boots"] = {"Teir 5 Boots", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T5Legs"] = {"Teir 5 Legs", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T5Helms"] = {"Teir 5 Helms", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T5Chests"] = {"Teir 5 Chests", "AtlasLootOriginalWoW" };
	--T6 Token Tables
	AtlasLoot_TableNames["T6Bracers"] = {"Teir 6 Bracers", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T6Belts"] = {"Teir 6 Belts", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T6Gloves"] = {"Teir 6 Gloves", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T6Shoulders"] = {"Teir 6 Shoulders", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T6Boots"] = {"Teir 6 Boots", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T6Legs"] = {"Teir 6 Legs", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T6Helms"] = {"Teir 6 Helms", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["T6Chests"] = {"Teir 6 Chests", "AtlasLootOriginalWoW" };
