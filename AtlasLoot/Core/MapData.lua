...
AtlasLoot_MapData = {
    ...
    ["BlackrockDepths"] = {
        ...
        [1] = {
            ...
            { AL["Lord Roccor"], cords = {57,65} };
            { AL["Kharan Mighthammer"], cords = {52,82} };
            { AL["Commander Gor'shak <Kargath Expeditionary Force>"], cords = {54,87} };
            { AL["Marshal Windsor"], cords = {53,94} };
            { AL["High Interrogator Gerstahn <Twilight's Hammer Interrogator>"], cords = {48,91} };
            { AL["Ring of Law"], cords = {51,61} };
            ...
            { AL["Pyromancer Loregrain"], cords = {57,69} };
            { AL["Monument of Franclorn Forgewright"] };
            { AL["Fineous Darkvire <Chief Architect>"], cords = {64,21} };
            { AL["Lord Incendius"], cords = {56,31} };
            { AL["The Black Anvil"] };
            { AL["Bael'Gar"], cords ={26,53} };
        };
        [2] = {
            { BabbleSubZone["Shadowforge City"], SubZone = true };
            { AL["The Vault"], cords = {60,66} };
            { AL["Warder Stilgiss"] };
            { AL["Verek"] };
            { AL["Watchman Doomgrip"] };
            { AL["Ring of Law"], cords = {51,89} };
            { AL["Shadowforge Lock"], cords = {42,91} };
            { AL["General Angerforge"], cords = {36,83} };
            { AL["Golem Lord Argelmach"], cords = {36,65} };
            { AL["Field Repair Bot 74A"] };
            { AL["Blacksmithing Plans"] };
            { AL["The Grim Guzzler"], cords = {50,63} };
            ...
            { AL["Ambassador Flamelash"], cords = {55,49} };
            { AL["Panzor the Invincible"].." ("..AL["Rare"]..")", cords = {50,35} };
            { AL["Blacksmithing Plans"] };
            { AL["Summoner's Tomb"], cords = {54,25} };
            { AL["The Lyceum"], cords = {67,12} };
            { AL["Magmus"], cords = {81,12} };
            { AL["Emperor Dagran Thaurissan"], cords = {91,12} };
            { AL["Princess Moira Bronzebeard <Princess of Ironforge>"] };
            { AL["High Priestess of Thaurissan"] };
            { AL["The Black Forge"], cords = {63,25} };
            { BabbleZone["Molten Core"], cords = {68,36} };
            { AL["Core Fragment"] };
        };
    };
    ["BlackrockSpire"] = {
        ...
        [4] = {
            ...
            { AL["Urok's Tribute Pile"], cords = {46,55} };
            { AL["Urok Doomhowl"].." ("..AL["Summon"]..")" };
            { AL["Bannok Grimaxe <Firebrand Legion Champion>"].." ("..AL["Rare"]..")", cords = {46,65} };
        };
        [5] = {
            { BabbleZone["Blackrock Spire"].." ("..AL["Lower"]..")", Zone = true };
            { BabbleSubZone["Dragonspire Hall"], SubZone = true };
            { AL["Quartermaster Zigris <Bloodaxe Legion>"], cords = {55,85} };
            { AL["Halycon"], cords = {38,85} };
            { AL["Gizrul the Slavener"] };
            { AL["Ghok Bashguud <Bloodaxe Champion>"].." ("..AL["Rare"]..")", cords = {35,68} };
        };
        [6] = {
            { BabbleZone["Blackrock Spire"].." ("..AL["Upper"]..")", Zone = true };
            { BabbleSubZone["The Rookery"], SubZone = true };
            { AL["Pyroguard Emberseer"], cords = {31,27} };
            { AL["Solakar Flamewreath"], cords = {39,39} };
            { AL["Father Flame"] };
            { AL["Darkstone Tablet"], cords = {32,42} };
            { AL["Doomrigger's Coffer"] };
            { AL["Overlord Wyrmthalak"], cords = {58,64} };
        };
        [7] = {
            { BabbleZone["Blackrock Spire"].." ("..AL["Upper"]..")", Zone = true };
            { BabbleSubZone["Blackrock Stadium"], SubZone = true };
            { AL["Jed Runewatcher <Blackhand Legion>"].." ("..AL["Rare"]..")", cords = {38,24} };
            { AL["Goraluk Anvilcrack <Blackhand Legion Armorsmith>"], cords = {33,27} };
            { AL["Warchief Rend Blackhand"], cords = {49,27} };
            { AL["Gyth <Rend Blackhand's Mount>"] };
            { AL["Awbee"], cords = {49,36} };
            { AL["The Beast"], cords = {64,32} };
            { AL["Lord Valthalak"].." ("..AL["Summon"]..")" };
            { AL["Finkle Einhorn"] };
            { AL["General Drakkisath"], cords = {36,50} };
    ...
    ["TheDeadmines"] = {
        ...
        [1] = {
            ...
            { AL["Rhahk'Zor <The Foreman>"], cords = {36,62} };
            { AL["Miner Johnson"].." ("..AL["Rare"]..")", cords = {51,51} };
            { AL["Sneed <Lumbermaster>"], cords = {51,86} };
            { AL["Sneed's Shredder <Lumbermaster>"] };
            { AL["Gilnid <The Smelter>"], cords = {61,57} };

        };
        [2] = {
            { BabbleSubZone["Ironclad Cove"], SubZone = true };
            { AL["Defias Gunpowder"], cords = {20,55} };
            { AL["Captain Greenskin"], cords = {61,38} };
            { AL["Edwin VanCleef <Defias Kingpin>"], cords = {61,46} };
            { AL["Mr. Smite <The Ship's First Mate>"], cords = {56,26} };
            { AL["Cookie <The Ship's Cook>"], cords = {68,43} };
        };
    };
    ["DireMaul"] = {
        ...
        [1] = {
            ...
            { AL["Stomper Kreeg <The Drunk>"], cords = {61,68} };
            { AL["Guard Fengus"], cords = {42.9,77.6} };
            { AL["Knot Thimblejack"] };
            { AL["Guard Slip'kik"], cords = {26.5,57.8} };
        ...
        [2] = {
            ...
            { AL["Illyanna Ravenoak"], cords = {20,78} };
            { AL["Tendris Warpwood"], cords = {33.4,53.5} };
        };
        [3] = {
            { BabbleSubZone["Court of the Highborne"].." (West)" , SubZone = true};
            { AL["Shen'dralar Ancient"] };
            { AL["Magister Kalendris"], cords = {32,45.3} };
        };
        [4] = {
            ...
            { AL["Lord Hel'nurath"].." ("..AL["Summon"]..")", cords = {14.9,55.7} };
        ...
        [5] = {
            ...
            { AL["Zevrim Thornhoof"] };
            { AL["Hydrospawn"], cords = {41,49.2} };
            { AL["Lethtendris"], cords = {44.5,46.6} };
            { AL["Pimgib"] };
        };
        [6] = {
    ...
    ["Gnomeregan"] = {
        ...
        [1] = {
            ...
            { AL["Blastmaster Emi Shortfuse"], cords = {77,68} };
            { AL["Grubbis"] };
            { AL["Chomper"] };
            { AL["Viscous Fallout"], cords = {50,50} };
        };
        [2] = {
    ...
    ["Maraudon"] = {
        ...
        [1] = {
            ...
            { AL["Noxxion"], cords = {36,15} };
            { AL["Razorlash"], cords = {18,33} };
            { AL["Maraudos <The Fourth Khan>"], cords = {53,74} };
            { AL["Lord Vyletongue"], cords = {37,72} };
            { AL["Meshlok the Harvester"].." ("..AL["Rare"]..")" };
            { AL["Celebras the Cursed"], cords = {10,65} };
        };
        [2] = {
            { AL["Zaetar's Grave"], SubZone = true };
            { AL["Celebras the Cursed"], cords = {25,15} };
            { AL["Landslide"], cords = {40.6,48.2} };
            { AL["Tinkerer Gizlock"], cords = {48.4,68.6} };
            { AL["Rotgrip"], cords = {33.3,77.1} };
            { AL["Princess Theradras"], cords = {24.2,80.4} };
    ...
    ["RagefireChasm"] = {
        ...
        [1] = {
            ...
            { AL["Maur Grimtotem"] };
            { AL["Oggleflint <Ragefire Chieftain>"], cords = {56.2,38.6} };
            { AL["Taragaman the Hungerer"], cords = {40.9,59} };
            { AL["Jergosh the Invoker"], cords = {38.9,82.9} };
            { AL["Zelemar the Wrathful"].." ("..AL["Summon"]..")" };
            { AL["Bazzalan"], cords = {42.4,85.4} };
        };
    };
    ["RazorfenDowns"] = {
        ...
        [1] = {
            ...
            { AL["Tuten'kash"], cords = {67.1,41.2} };
            { AL["Henry Stern"] };
            { AL["Belnistrasz"] };
            { AL["Sah'rhee"] };
            { AL["Mordresh Fire Eye"], cords = {85.8,45.7} };
            { AL["Glutton"], cords = {38.5,45.2} };
            { AL["Ragglesnout"].." ("..AL["Rare"]..", "..AL["Varies"]..")" };
            { AL["Amnennar the Coldbringer"], cords = {45,59.1} };
    ...
    ["RazorfenKraul"] = {
        ...
        [1] = {
            { AL["Entrance"] };
            { AL["Roogug"], cords = {65,48} };
            { AL["Aggem Thorncurse <Death's Head Prophet>"], cords = {81,53} };
            { AL["Death Speaker Jargba <Death's Head Captain>"], cords = {88,41} };
            { AL["Overlord Ramtusk"], cords = {56,30} };
            { AL["Razorfen Spearhide"] };
            { AL["Agathelos the Raging"], cords = {9,68} };
            { AL["Blind Hunter"].." ("..AL["Rare"]..")", cords = {11,31} };
            { AL["Charlga Razorflank <The Crone>"], cords = {22,31} };
    ...
    ["ScarletMonastery"] = {
        ...
        [2] = {
            ...
            { AL["Houndmaster Loksey"], cords = {30,85} };
            { AL["Arcanist Doan"], cords = {83,77} };
        };
        [3] = {
            { BabbleZone["Armory"], SubZone = true };
            { AL["Herod <The Scarlet Champion>"], cords = {79,11} };
        };
        [4] = {
            { BabbleZone["Cathedral"], SubZone = true };
            { AL["High Inquisitor Fairbanks"], cords = {56,26} };
            { AL["Scarlet Commander Mograine"], cords = {49,29} };
            { AL["High Inquisitor Whitemane"], cords = {48,17} };
        };
    };
    ["Scholomance"] = {
        ...
        MapName = "Scholomance";
        [1] = {
        { AL["Reputation"]..": "..AL["Argent Dawn"] };
        { AL["Key"]..": "..AL["Skeleton Key"] };
        { AL["Key"]..": "..AL["Viewing Room Key"].." ("..AL["Viewing Room"]..")" };
        { AL["Key"]..": "..AL["Blood of Innocents"].." ("..AL["Kirtonos the Herald"]..")" };
        { AL["Key"]..": "..AL["Brazier of Invocation"].." ("..AL["DS2"]..")" };
        { AL["Key"]..": "..AL["Divination Scryer"].." ("..AL["Death Knight Darkreaver"]..")" };
        { AL["Entrance"] };
        { AL["Connection"] };
        { AL["Connection"] };
    ...
    ["TheStockade"] = {
        ...
        { AL["Targorr the Dread"], cords = {50,25} };
        { AL["Kam Deepfury"], cords = {69,30} };
        { AL["Hamhock"], cords = {78,46} };
        { AL["Bazil Thredd"], cords = {86,51} };
        { AL["Dextren Ward"], cords = {22,26} };
        { AL["Bruegal Ironknuckle"].." ("..AL["Rare"]..")", cords = {30,43} };
        };
    };
    ["Stratholme"] = {
        ...
        [1] = {
        { AL["Reputation"]..": "..AL["Argent Dawn"] };
        { AL["Key"]..": "..AL["The Scarlet Key"].." ("..AL["Living Side"]..")" };
        { AL["Key"]..": "..AL["Key to the City"].." ("..AL["Undead Side"]..")" };
        { AL["Key"]..": "..AL["Various Postbox Keys"].." ("..AL["Postmaster Malown"]..")" };
        { AL["Key"]..": "..AL["Brazier of Invocation"].." ("..AL["DS2"]..")" };
        ...
        { AL["Baron Rivendare"] };
        { AL["Ysida Harmon"] };
        { AL["Crusaders' Square Postbox"] };
        { AL["Market Row Postbox"] };
        { AL["Festival Lane Postbox"] };
        { "4') "..AL["Elders' Square Postbox"] };
        { "5') "..AL["King's Square Postbox"] };
        { "6') "..AL["Fras Siabi's Postbox"] };
    ...
    ["TheSunkenTemple"] = {
        ...
        [1] = {
        { AL["AKA"]..": "..BabbleZone["The Temple of Atal'Hakkar"] };
        { AL["Key"]..": "..AL["Yeh'kinya's Scroll"].." ("..AL["Avatar of Hakkar"]..")" };
        { AL["Entrance"] };
        { "B-I) "..AL["Connection"] };
        { AL["Altar of Hakkar"] };
