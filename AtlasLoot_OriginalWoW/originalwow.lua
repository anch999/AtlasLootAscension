...
AtlasLoot_Data["MoltenCore"] = {
	...
	};
	{
		...
		[25] = { itemID = 102107, [AtlasLoot_Difficulty.MIN_DIF] = AtlasLoot_Difficulty.Heroic  }; -- Reins of the Magmatic Steed
	};
	{
...
AtlasLoot_Data["Onyxia60"] = {
	...
	Map = "Onyxia60";
	{
		...
		[26] = { itemID = 49636, [AtlasLoot_Difficulty.MIN_DIF] = AtlasLoot_Difficulty.Heroic  }; -- Reins of the Onyxian Drake
	};
};
...
AtlasLoot_Data["T2"] = {
	...
	Type = "ClassicRaid";
	{
		...
		[5] = { itemID = 16899, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Stormrage Handguards
	...
	};
	{
		...
		[5] = { itemID = 1516904, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Stormrage Handguards
	...
	};
	{
		...
		[5] = { itemID = 1516891, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Stormrage Handguards
	...
	};
	{
		...
		[5] = { itemID = 16940, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Dragonstalker's Gauntlets
	...
	};
	{
		...
		[5] = { itemID = 16913, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Netherwind Gloves
	...
	};
	{
		...
		[5] = { itemID = 16956, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Judgement Gauntlets
	...
	};
	{
		...
		[5] = { itemID = 1516956, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Judgement Gauntlets
	...
	};
	{
		...
		[5] = { itemID = 16920, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Handguards of Transcendence
	...
	};
	{
		...
		[5] = { itemID = 1516920, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Handguards of Transcendence
	...
	};
	{
		...
		[5] = { itemID = 16907, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Bloodfang Gloves
	...
	};
	{
		...
		[5] = { itemID = 16948, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Gauntlets of Ten Storms
	...
	{		
		...
		[5] = { itemID = 1516948, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Gauntlets of Ten Storms
	...
	};
	{
		...
		[5] = { itemID = 16928, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Nemesis Gloves
	...
	};
	{
		...
		[5] = { itemID = 10905, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Grippers of Wrath
	...
	};
	{
		...
		[5] = { itemID = 16964, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Gauntlets of Wrath
	...
	};
	{
		...
		[5] = { itemID = 1516964, desc = "=ds=" .. BabbleBoss["Firemaw"] .. ", " .. BabbleBoss["Ebonroc"] .. ", " .. BabbleBoss["Flamegor"]  };--Grippers of Wrath
...
AtlasLoot_Data["ClassicSets"] = {
	Name = AL["Classic Sets"];
	{
		...
		[1] = { itemID = 10399, desc =  "=ds=#s5#, =q2=#n6#", droprate = "14.77%" }; --Blackened Defias Armor
		[2] = { itemID = 10401, desc =  "=ds=#s9#, =q2=#n9#", droprate = "1.76%" }; --Blackened Defias Gloves
		[3] = { itemID = 10403, desc =  "=ds=#s10#, =q2=#n7#", droprate = "23.26%" }; --Blackened Defias Belt
		[4] = { itemID = 10400, desc =  "=ds=#s11#, =q2=#n9#", droprate = "1.64%" }; --Blackened Defias Leggings
		[5] = { itemID = 10402, desc =  "=ds=#s12#, =q2=#n8#", droprate = "1.23%" }; --Blackened Defias Boots
	};
	{
		Name = AL["Embrace of the Viper"];
		[1] = { itemID = 6473, desc =  "=ds=#s5#, =q2=#n5#", droprate = "52.05%" }; --Armor of the Fang
		[2] = { itemID = 10413, desc =  "=ds=#s9#, =q2=#n4#", droprate = "1.20%" }; --Gloves of the Fang
		[3] = { itemID = 10412, desc =  "=ds=#s10#, =q2=#n2#", droprate = "8.64%" }; --Belt of the Fang
		[4] = { itemID = 10410, desc =  "=ds=#s11#, =q2=#n1#", droprate = "16.03%" }; --Leggings of the Fang
		[5] = { itemID = 10411, desc =  "=ds=#s12#, =q2=#n3#", droprate = "19.08%" }; --Footpads of the Fang
	};
	{
		Name = AL["Chain of the Scarlet Crusade"];
		[1] = { itemID = 10328, desc =  "=ds=#s5#, =q2=#n12#", droprate = "0.3%" }; --Scarlet Chestpiece
		[2] = { itemID = 10333, desc =  "=ds=#s8#, =q2=#n15#", droprate = "1.6%" }; --Scarlet Wristguards
		[3] = { itemID = 10331, desc =  "=ds=#s9#, =q2=#n13#", droprate = "1.7%" }; --Scarlet Gauntlets
		[4] = { itemID = 10329, desc =  "=ds=#s10#, =q2=#n10#", droprate = "1.6%" }; --Scarlet Belt
		[5] = { itemID = 10330, desc =  "=ds=#s11#, =q2=#n14#", droprate = "13.2%" }; --Scarlet Leggings
		[6] = { itemID = 10332, desc =  "=ds=#s12#, =q2=#n11#", droprate = "0.1%" }; --Scarlet Boots
	};
	{
		Name = AL["The Gladiator"];
		[1] = { itemID = 11729, desc =  "=ds=#s1#, =q2=#brd3#, #brd5#", droprate = "10.08%" }; --Savage Gladiator Helm
		[2] = { itemID = 11726, desc =  "=ds=#s5#, =q2=#brd3#", droprate = "14.52%" }; --Savage Gladiator Chain
		[3] = { itemID = 11730, desc =  "=ds=#s9#, =q2=#brd2#", droprate = "14.12%" }; --Savage Gladiator Grips
		[4] = { itemID = 11728, desc =  "=ds=#s11#, =q2=#brd6#", droprate = "14.95%" }; --Savage Gladiator Leggings
		[5] = { itemID = 11731, desc =  "=ds=#s12#, =q2=#brd1#", droprate = "15.14%" }; --Savage Gladiator Greaves
	};
	{
		Name = AL["Ironweave Battlesuit"];
		[1] = { itemID = 22302, desc =  "=ds=#s1#, =q2=#n16# (#z9#)", droprate = "27.72%" }; --Ironweave Cowl
		[2] = { itemID = 22305, desc =  "=ds=#s3#, =q2=#n17# (#z4#)", droprate = "30.39%" }; --Ironweave Mantle
		[3] = { itemID = 22301, desc =  "=ds=#s5#, =q2=#n18# (#z6#)", droprate = "19.00%" }; --Ironweave Robe
		[4] = { itemID = 22313, desc =  "=ds=#s8#, =q2=#n19# (#z10#)", droprate = "18.16%" }; --Ironweave Bracers
		[5] = { itemID = 22304, desc =  "=ds=#s9#, =q2=#n20# (#z13#)", droprate = "16.24%" }; --Ironweave Gloves
		[6] = { itemID = 22306, desc =  "=ds=#s10#, =q2=#n21# (#z10#)", droprate = "20.28%" }; --Ironweave Belt
		[7] = { itemID = 22303, desc =  "=ds=#s11#, =q2=#n22# (#z5#)", droprate = "23.33%" }; --Ironweave Pants
		[8] = { itemID = 22311, desc =  "=ds=#s12#, =q2=#n23# (#z9#)", droprate = "12.31%" }; --Ironweave Boots
	};
	{
	...
	};
	{
		...
		[1] = { itemID = 17082, desc =  "=ds=#s14#, =q2=#n35# (#z14#)", droprate = "4.46%" }; --Shard of the Flame
		[2] = { itemID = 17064, desc =  "=ds=#s14#, =q2=#n36# (#z15#)", droprate = "3.71%" }; --Shard of the Scale
	};
	{
	...
	};
	{
		...
		[1] = { itemID = 14633, desc =  "=ds=#s3#", droprate = "1.12%" }; --Necropile Mantle
		[2] = { itemID = 14626, desc =  "=ds=#s5#", droprate = "1.27%" }; --Necropile Robe
		[3] = { itemID = 14629, desc =  "=ds=#s8#", droprate = "1.03%" }; --Necropile Cuffs
		[4] = { itemID = 14632, desc =  "=ds=#s11#", droprate = "0.85%" }; --Necropile Leggings
		[5] = { itemID = 14631, desc =  "=ds=#s12#", droprate = "0.88%" }; --Necropile Boots
	};
	{
		Name = AL["Cadaverous Garb"];
		[1] = { itemID = 14637, desc =  "=ds=#s5#", droprate = "1.51%" }; --Cadaverous Armor
		[2] = { itemID = 14640, desc =  "=ds=#s9#", droprate = "0.82%" }; --Cadaverous Gloves
		[3] = { itemID = 14636, desc =  "=ds=#s10#", droprate = "0.60%" }; --Cadaverous Belt
		[4] = { itemID = 14638, desc =  "=ds=#s11#", droprate = "1.09%" }; --Cadaverous Leggings
		[5] = { itemID = 14641, desc =  "=ds=#s12#", droprate = "0.67%" }; --Cadaverous Walkers
	};
	{
		Name = AL["Bloodmail Regalia"];
		[1] = { itemID = 14611, desc =  "=ds=#s5#", droprate = "0.54%" }; --Bloodmail Hauberk
		[2] = { itemID = 14615, desc =  "=ds=#s9#", droprate = "0.09%" }; --Bloodmail Gauntlets
		[3] = { itemID = 14614, desc =  "=ds=#s10#", droprate = "0.60%" }; --Bloodmail Belt
		[4] = { itemID = 14612, desc =  "=ds=#s11#", droprate = "0.42%" }; --Bloodmail Legguards
		[5] = { itemID = 14616, desc =  "=ds=#s12#", droprate = "0.36%" }; --Bloodmail Boots
	};
	{
		Name = AL["Deathbone Guardian"];
		[1] = { itemID = 14624, desc =  "=ds=#s5#", droprate = "0.45%" }; --Deathbone Chestplate
		[2] = { itemID = 14622, desc =  "=ds=#s9#", droprate = "0.45%" }; --Deathbone Gauntlets
		[3] = { itemID = 14620, desc =  "=ds=#s10#", droprate = "0.67%" }; --Deathbone Girdle
		[4] = { itemID = 14623, desc =  "=ds=#s11#", droprate = "1.12%" }; --Deathbone Legguards
		[5] = { itemID = 14621, desc =  "=ds=#s12#", droprate = "0.57%" }; --Deathbone Sabatons
	};
	{
		Name = AL["Major Mojo Infusion"];
		[1] = { itemID = 19898, desc =  "=ds=#s13#, =q2=#n28#", droprate = "8.81%" }; --Seal of Jin
		[2] = { itemID = 19925, desc =  "=ds=#s13#, =q2=#n29#", droprate = "10.36%" }; --Band of Jin
	};
	{
		Name = AL["Overlord's Resolution"];
		[1] = { itemID = 19873, desc =  "=ds=#s13#, =q2=#n33#", droprate = "10.12%" }; --Overlord's Crimson Band
		[2] = { itemID = 19912, desc =  "=ds=#s13#, =q2=#n30#", droprate = "14.51%" }; --Overlord's Onyx Band
	};
	{
	...
	};
	{
		...
		[1] = { itemID = 19863, desc =  "=ds=#s13#, =q2=#n33#", droprate = "9.72%" }; --Primalist's Seal
		[2] = { itemID = 19920, desc =  "=ds=#s13#, =q2=#n31#", droprate = "8.95%" }; --Primalist's Band
	};
	{
		Name = AL["Zanzil's Concentration"];
		[1] = { itemID = 19905, desc =  "=ds=#s13#, =q2=#n32#", droprate = "9.24%" }; --Zanzil's Band
		[2] = { itemID = 19893, desc =  "=ds=#s13#, =q2=#n33#", droprate = "10.12%" }; --Zanzil's Seal
	};
	{
...
AtlasLoot_Data["WorldEpicsCLASSIC"] = {
	...
	};
	{
		...
		[25] = { itemID = 1169, desc =  "=ds=#w8#"  };--Blackskull Shield
		[26] = { itemID = 1979, desc =  "=ds=#w8#"  };--Wall of the Dead
		[27] = { itemID = 2824, desc =  "=ds=#w2#"  };--Hurricane
...
AtlasLoot_Data["WorldBossesCLASSIC"] = {
	...
	Type = "ClassicRaid";
	{
		...
		[15] = {itemID = 18714, desc = "=q1=#m4#: =ds=#m14# #w19#%" }; --Ancient Sinew Wrapped Lamina
